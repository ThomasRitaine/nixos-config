{ lib, ... }: {
  programs.starship = {
    ...
    settings =
      { # Color gradient used : https://huemint.com/gradient-7/#palette=a3aed2-769ff0-3883c5-3c699a-31486e-2a3e4f-1d2230 From the brighter to the darker : #a3aed2, #769ff0, #3883c5, #3c699a, #31486e, #2a3e4f, #1d2230
